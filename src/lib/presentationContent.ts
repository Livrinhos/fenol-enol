...
export const chapters: PresentationChapter[] = [
  ...
  },
  {
    ...
    duration: "~1 min",
    bullets: [
      "OH direto no carbono aromático",
      "Fenol simples: C₆H₅OH",
      "Com carbono intermediário = álcool aromático",
    ],
  },
  {
    number: 7,
    ...
    duration: "~1 min",
    bullets: [
      "Polar, faz ligações de hidrogênio",
      "Mais ácido que álcoois",
      "Ressonância estabiliza a carga no anel",
    ],
  },
  {
    number: 8,
    ...
    bullets: [
      "Carbono do OH = C1",
      "2-metilfenol · 4-clorofenol",
      "orto (2) · meta (3) · para (4)",
    ],
  },
  {
    number: 9,
  ...
  },
  {
    ...
    duration: "~1 min",
    bullets: [
      "Resinas fenólicas e polímeros",
      "Intermediários químicos",
      "Desinfetantes e antissépticos",
      "Manuseio restrito e controlado",
    ],
  },
  {
    number: 11,
    ...
    bullets: [
      "en (alceno) + ol (álcool)",
      "OH no carbono da dupla C=C",
      "Estrutura geralmente instável",
    ],
  },
  {
    number: 12,
    ...
    duration: "~1 min",
    bullets: [
      "Dupla C=C + OH no mesmo carbono da dupla",
      "Sufixo -enol",
  ...
  },
  {
    ...
    duration: "~1 min",
    bullets: [
      "Enol ⇌ forma ceto (carbonílica)",
      "Migração de H + deslocamento da dupla",
      "Forma ceto costuma predominar",
    ],
  },
  {
    number: 14,
    ...
    bullets: [
      ...
      "Pentano-2,4-diona: enol mais estabilizado",
    ],
  },
  {
    number: 15,
    ...
    duration: "~1 min",
    bullets: [
      "Intermediário em reações de carbonilados",
      "Presente em rotas bioquímicas",
      "Valor conceitual e mecanístico",
    ],
  },
  {
    number: 16,
    ...
    duration: "~1 min",
    bullets: [
      "Fenol: aplicação industrial concreta",
      "Enol: chave para mecanismos",
      "Importâncias diferentes, ambas reais",
    ],
  },
  {
    number: 17,
  ...
  },
  {
    ...
    duration: "~1 min",
    bullets: [
      "Grupo funcional define a função",
      "Função define as propriedades",
      "Propriedades definem o uso",
    ],
  },
  {
    number: 20,
