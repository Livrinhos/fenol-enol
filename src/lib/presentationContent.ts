...
export const chapters: PresentationChapter[] = [
  {
    ...
    duration: "~1 min",
    bullets: [
      "Milhões de compostos, poucas categorias",
      "Mesma parte reativa = comportamento parecido",
      "Classificar para prever",
    ],
  },
  {
    number: 2,
  ...
  },
  {
    ...
    duration: "~1 min",
    bullets: [
      "Álcool: OH em carbono saturado",
      "Fenol: OH em carbono aromático",
      "Enol: OH em carbono de C=C",
    ],
  },
  {
    number: 4,
    ...
    duration: "~1 min",
    bullets: [
      "1. Achar heteroátomos",
      "2. Achar insaturações",
      "3. Analisar o carbono ligado ao grupo",
    ],
  },
  {
    number: 5,
  ...
  },
  {
    ...
    summary: "Fenol, cresóis, catecol, hidroquinona e timol mostram a variedade da função.",
    script:
  ...
  },
  {
    ...
    summary: "Os fenóis são matéria-prima de resinas e polímeros, além de intermediários químicos e componentes de desinfetantes.",
    script:
  ...
  },
  {
    ...
    summary: "Enol é a função em que a hidroxila está ligada a um carbono que participa de uma dupla ligação C=C.",
    script:
  ...
  },
  {
    ...
    summary: "O nome indica a posição da dupla e a posição do OH na mesma cadeia, com o sufixo -enol.",
    script:
  ...
  },
  {
    ...
    summary: "A forma enol e a forma carbonílica se interconvertem pela migração de um hidrogênio e mudança da posição da dupla.",
    script:
  ...
  },
  {
    ...
    summary: "Etenol/etanal e prop-1-en-2-ol/propanona são os exemplos didáticos; a pentano-2,4-diona tem forma enol mais estabilizada.",
    script:
  ...
  },
  {
    ...
    summary: "Os enóis funcionam como etapas intermediárias em transformações de compostos carbonílicos e em processos bioquímicos.",
    script:
  ...
  },
  {
    ...
    summary: "Os fenóis importam pelo uso material e industrial; os enóis importam por explicar mecanismos de reação.",
    script:
  ...
  },
  {
    ...
    summary: "Mesmo grupo OH, contextos opostos: anel aromático estável contra dupla C=C reativa.",
    script:
  ...
  },
  {
    ...
    summary: "Nem todo OH é álcool, fenol não é enol, e a forma enol nem sempre é minoritária.",
    script:
  ...
  },
  {
    ...
    summary: "Uma linha lógica conecta tudo o que foi apresentado nas quatro partes.",
    script:
  ...
  },
  {
    ...
    summary: "A química orgânica se organiza por padrões; fenol e enol mostram como um detalhe estrutural muda tudo.",
    script:
...
export const sources: PresentationSource[] = [
  { org: "IUPAC", note: "Recomendações de nomenclatura de compostos orgânicos." },
  { org: "Livros didáticos de Química Orgânica", note: "Obras introdutórias de graduação usadas como referência conceitual." },
  { org: "Livros didáticos do Ensino Médio", note: "Volumes de química com capítulos de funções orgânicas e nomenclatura." },
  { org: "Material de apoio escolar", note: "Apostilas e roteiros de aula sobre grupos funcionais, fenóis e enóis." },
];

export const TOTAL_CHAPTERS = chapters.length;
export function chaptersOfPart(part: number): PresentationChapter[] { return chapters.filter((c) => c.part === part); }
export function findPresentationChapter(n: number): PresentationChapter | undefined { return chapters.find((c) => c.number === n); }
export function findPart(n: number): PresentationPart | undefined { return parts.find((p) => p.number === n); }
